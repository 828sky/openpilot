...
_AWARENESS_TIME = 50400.  # one minute limit without user touching steering wheels make the car enter a terminal status * changed from 70 to 50400
...
_DISTRACTED_TIME = 110000000. #changed from 11 to 110000000
_DISTRACTED_PRE_TIME_TILL_TERMINAL = 80000000. #changed from 8 to 80000000
_DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 60000000. #changed from 6 to 60000000
...
MAX_TERMINAL_ALERTS = 300000 # not allowed to engage after 3 terminal alerts *changed from 3 to 300000
MAX_TERMINAL_DURATION = 300000 # 30s *300 was default moved to 300000
